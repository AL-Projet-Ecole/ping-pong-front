...
export default () => {
    const cards = [
        { imageSrc: ShieldIconImage, title: "Ventes", link: "/Postes" },
        { imageSrc: ShieldIconImage, title: "Commandes", link: "/Commandes" },
        { imageSrc: ReliableIconImage, title: "Clients", link: "/Clients" },
        { imageSrc: FastIconImage, title: "Devis", link: "/Devis" },
        { imageSrc: FastIconImage, title: "Fournisseurs", link: "/Fournisseurs" },
    ];
        ...
        <AnimationRevealPage>
            <Container>
                <ThreeColumnContainer>
                    <Heading><span tw="text-primary-500">Hub</span> Commercial</Heading>
                    {cards.map((card, i) => (
                        <Column key={i}>
                            <Link to={card.link}>
                                <Card>
